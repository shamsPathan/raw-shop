...
Refurbished Machine, &amp;amp; Export on medicalshopbd.com" />
  ...
  <meta name="msvalidate.01" content="D3EEE3D310D40FD5E9736EB53EF2D5E6" />
  ...
  <link rel="stylesheet" href="<?= PATH ?>css/hiring.css">
  ...
  <script type="application/ld+json">
    {
      ...
      We offer full service from our strong service teem that meets highest quality standard and we focus on delivering trans formative invasion that bring smarter,
      more personalized care to all of us.We want our customer to be able to rely on our excellent qualit ",
  ...
  <script>
    ...
    gtag('config', 'UA-129274489-1', {
      'optimize_id': 'GTM-NCN8FMT'
    });
  </script>
...
<![endif]-->
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-4" style="text-align: center">
        ...
        if (!($_SESSION['user']['id'] ?? null)) { ?>
          <a href="<?= PATH ?>ui/registration" style="float:right">Register</a>
          ...
          if ($_SESSION['user']['fname'] ?? null) { ?>
            ...
            <a href="<?= PATH ?>ui/dashboard" style="float:right;background: #6ebe44">Dashboard</a>
        <?php
          }
        }
        ?>
  ...
  <!-- Start Header Style -->
  <header id="header" class="htc-header header--3 bg__white" style="box-shadow: 0px 2px 1px green;">
    <!-- Start Mainmenu Area -->
    <div id="sticky-header-with-topbar" class="mainmenu__area sticky__header" style="box-shadow: 0px 2px 1px green;">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 hidden-xs hidden-sm ">
            <ul class="menu-extra">
              <li class="search search__open hidden-xs"><span class="ti-search">
        ...
        <div class="row">
          ...
          <div class="col-md-2 col-sm-2 col-xs-2 visible-xs visible-sm">
          ...
          <div class="col-md-1 col-sm-1 col-xs-1 visible-xs visible-sm">
            <br>
          </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-4 visible-xs visible-sm">
            <div class="logo">

              <a href="<?= PATH ?>">
                <img src="<?= PATH ?>images/logo/logo.png" width="105%" alt="logo">
              </a>
            </div>
          </div>
            ...
            <div class="input-group">
              <div class="input-group-btn search-panel">
                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span id="search_concept">Department</span> <span class="caret"></span>
                </button>
