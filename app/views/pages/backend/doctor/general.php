    ...
    <div class="row">
      <div class="col-md-3">
        <div class="list-group">
          ...
          <a href="<?= PATH ?>doctor/general/edit" class="list-group-item">
            Your Profile Edit</a>
        </div>
          ...
          <div class="panel-body">
            <div class="col-md-4">
              <p style="font-size:20px;">
                ...
                <h4 style="padding-top: 5px;color: #66cc00"> <?= $user['name'] ?></h4>
                <h4 style="padding-top: 10px; color: #006687;font-size:16px"> Department</h4>
                <h4 style="padding-top: 5px;color: #66cc00"><?= $user['department'] ?></h4>
                <h4 style="padding-top: 10px; color: #006687;font-size:16px"> Chamber</h4>
                <h4 style="padding-top: 5px;color: #66cc00"><?= $user['chamber'] ?></h4>
            ...
            <div class="col-md-4">
              <p style="font-size:20px;">
                ...
                <h4 style="padding-top: 5px;color: #66cc00"> <?= $user['email'] ?></h4>

                <h4 style="padding-top: 10px; color: #006687;font-size:16px"> Home Address</h4>
                <h4 style="padding-top: 5px;color: #66cc00"> <?= $user['address'] ?></h4>
              </p>
              <br>
