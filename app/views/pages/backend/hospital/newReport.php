...
<div class="page-content container">
    ...
    <form action="/reception/makeReport" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="patient_id" type="number" class="form-control" id="id-form-field-1">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-3 col-form-label text-sm-right pr-0">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="file" name="images[]" multiple class="form-control form-control-lg  d-inline-block mb-1 mb-md-0">
                    </div>
                </div>
