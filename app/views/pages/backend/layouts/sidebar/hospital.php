        ...
        <div class="ace-scroll flex-grow-1" ace-scroll>
            ...
            <ul class="nav has-active-border" role="navigation" aria-label="Main">
                    ...
                    <div class="hideable submenu collapse">
                        <ul class="submenu-inner">
                            ...
                            <li class="nav-item">
                                ...
                                <a href="/hospital/appointments" class="nav-link">
                            ...
                            <li class="nav-item">
                                ...
                                <a href="/hospital/appointments/new" class="nav-link">
                    ...
                    <div class="hideable submenu collapse">
                        <ul class="submenu-inner">
                            ...
                            <li class="nav-item">
                                ...
                                <a href="/hospital/reports/new" class="nav-link">
                ...
                <li class="nav-item">
                    ...
                    <a target="_blank" href="/hospital/general" class="nav-link">
