    ...
    <div class="row">
      <div class="col-md-3">
        <div class="list-group">
          ...
          <h5 style="text-align:center;"><strong id="user-name"><?= $user['first_name']?> <?= $user['last_name']?></strong></h5>
          ...
          <a href="<?= PATH ?>patient/general/edit" class="list-group-item">
            Your Profile Edit</a>
        </div>
          ...
          <div class="panel-body">
            <div class="col-md-4">
              <p style="font-size:20px;">
                ...
                <h4 style="padding-top: 5px;color: #66cc00"> <?= $user['first_name'] ?></h4>

                <h4 style="padding-top: 10px; color: #006687;font-size:16px"> Last Name</h4>
                <h4 style="padding-top: 5px;color: #66cc00"> <?= $user['last_name']?></h4>
