        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <ul class="login__register__menu" role="tablist">
                    <li role="presentation" class="register active"><a href="#register" role="tab" data-toggle="tab">Register (Hospital)</a></li>
                </ul>
            </div>
        </div>
                    ...
                    <div id="register" role="tabpanel" class="single__tabs__panel tab-pane fade in active">
                        <div class="login">
                            <form id="regForm" action="<?= PATH ?>users/goreg" method="post">
                                <input type="text" placeholder="Name of Hospital*" name="name">
                                <input type="text" placeholder="Authority First Name *" name="fname">
                                <input type="text" placeholder="Authority Last Name *" name="lname">
